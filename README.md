# Lenskart SaaS v3.0 — College Project
...
# Seed promo codes
db.merge(PromoCode(code='LENSKART10', discount_percentage=10, max_discount_amount=200, is_active=True))
